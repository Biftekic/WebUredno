  ...
  useEffect(() => {
    ...
    if (serviceSlug && services.length > 0) {
      ...
      if (service) {
        ...
        } else if (service.slug === 'daily-rental-cleaning') {
          setServiceType('daily_rental');
        } else if (service.slug === 'vacation-rental-deep') {
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {services
                .filter(service => {
                  if (serviceType === 'airbnb') return service.slug === 'airbnb-cleaning';
                  if (serviceType === 'daily_rental') return service.slug === 'daily-rental-cleaning';
